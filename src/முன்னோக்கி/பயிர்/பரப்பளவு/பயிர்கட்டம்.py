...
class பயிர்கட்டம்(பயிர்_பரப்பளவு):
    def __init__(
        ...
        தன்.பயிர்கள் = [பயிர்கள்] if isinstance(பயிர்கள், str) else பயிர்கள்

    def தரவுகளைப்_பெறு(தன்) -> xr.DataArray:
        பயிர்கள் = தன்.பயிர்கள் or தன்.இருக்கும்_பயிர்கள்()
        தரவு_பட்டியல் = []
        for பயிர் in பயிர்கள்:
            பதிவிறக்கம் = ஜிப்_பதிவிறக்கம்(
                பெயர்=f"{தன்.பதிவிறக்க_முகவரி}/{தன்.உள்_கோப்பு_பெயர்(பயிர்)}",
                பதிவிறக்க_முகவரி=தன்.பதிவிறக்க_முகவரி,
            )
            தரவுகள் = பதிவிறக்கம்.பெறு().rename({"lat": அகலாங்கு_அச்சு, "lon": நெட்டாங்கு_அச்சு})
