...
class காலநிலை(தாள், ABC):
    ...
    def தொலைவு(
        ...
        return மஹனலோபிஸ்(நெறிம்பபடுத்தப்பட்ட_இலக்கு, நெறிம்பபடுத்தப்பட்ட_மூல்)

    def ஒற்றுமை(
        தன், நிலநேர்க்கோடு: Number, நிலநிரைக்கொடு: Number, குறிப்பு: காலநிலை_குறிப்பு
    ) -> xr.DataArray:
        ...
        இலக்கு_மாறிகள் = தன்.தரவுகளைப்_பெறு(குறிப்பு)
