...
from .மாறிலிகள் import வறலாற்று_காட்சி
...
class கப்பென்_ஜைகர்(காலநிலை):
    ...
    def தரவுகளைப்_பெறு(தன், குறிப்பு: காலநிலை_குறிப்பு) -> xr.DataArray:
        ...
        தரவுகள் = ஜிப்_பதிவிறக்கம்(
            பெயர்=தன்.உள்_கோப்பு_பெயர்(ஆண்டு, காட்சி=காட்சி), பதிவிறக்க_முகவரி=தன்.பதிவிறக்க_முகவரி
        ).தரவுத்தளத்தைப்_பெறு()

        if காட்சி != வறலாற்று_காட்சி:
            தரவுகள் = தன்.வடிக்க(தரவுகள்)

        return தரவுகள்["kg_class"]
    ...
    def காலநிலை_குறிப்பு_சரிபார்த்தல்(தன், குறிப்பு: காலநிலை_குறிப்பு) -> சரிபார்த்த_காலநிலை_குறிப்பு:
        ...
        if சரிபார்த்த_குறிப்பு.மாதிரிகள் == தன்.மாதிரிகள்:
            warning("இந்த காலநிலை தாளில் தனி மாதிரிகளைக் குறிப்பிட முடியாது. அனைத்த மாதிரிகள் பயன்படுத்தபடும்.")
            சரிபார்த்த_குறிப்பு.மாதிரிகள் = set(தன்.மாதிரிகள்)
